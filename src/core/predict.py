...
import json
import cv2
from src.core.utils.utils import get_yolo_boxes, makedirs
from src.core.utils.bbox import draw_boxes
...
def _main_(args):
    ...
    model_path = os.path.join(ROOT_DIR, "../../models/yolov3.weights")
    ...
    if 'webcam' in input_path:  # do detection on the first webcam
        ...
        for image_path in image_paths:
            ...
            # predict the bounding boxes
            boxes = \
            get_yolo_boxes(infer_model, [image], net_h, net_w, config['model']['anchors'], obj_thresh, nms_thresh)[
                0]
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-i', '--input', default="webcam",
